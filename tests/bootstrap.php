...
class Slim_Framework_TestCase extends PHPUnit_Framework_TestCase
{
    ...
    public function setup() {
        ...
        require __DIR__ . '/../app/lib/RestAPI.php';
    ...
    private function request($method, $path, $formVars = array(), $optionalHeaders = array()) {
        ...
        // @TODO bugfix for put action
        if ( !isset($optionalHeaders['CONTENT_TYPE']) && strtoupper($method) == 'PUT' ) {
            $optionalHeaders['CONTENT_TYPE'] = 'application/x-www-form-urlencoded';
        }
        ...
        \Slim\Environment::mock(array_merge(array(
            ...
            'PATH_INFO'      => $path,
            'QUERY_STRING'   => strtoupper($method) == 'GET' ? http_build_query($formVars) : '',
